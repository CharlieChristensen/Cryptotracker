...
object Libraries {
    ...
    const val scarlett               = "com.tinder.scarlet:scarlet:${Versions.scarlett}"
    const val scarlettLifecycle      = "com.tinder.scarlet:lifecycle-android:${Versions.scarlett}"
    const val scarlettMoshi          = "com.tinder.scarlet:message-adapter-moshi:${Versions.scarlett}"
    const val scarlettCoroutines     = "com.tinder.scarlet:stream-adapter-coroutines:${Versions.scarlett}"
    const val scarlettOkHttp         = "com.tinder.scarlet:websocket-okhttp:${Versions.scarlett}"
