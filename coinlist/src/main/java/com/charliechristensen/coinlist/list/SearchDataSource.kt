...
class SearchDataSource(
    ...
    override fun loadInitial(
        ...
        val totalCount = interactor.getCoinCount(searchQuery).executeAsOne().toInt()
    ...
    private fun loadRange(limit: Int, offset: Int): List<SearchCoinsListItem> {
        ...
        return interactor.searchCoinsPaged(searchQuery, limit.toLong(), offset.toLong()).also { dbQuery ->
